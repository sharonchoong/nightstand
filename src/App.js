...
class WeatherIcon extends React.Component {
  ...
  weatherIcons = {
    0: {
      ...
      imgSrc:
        this.iconPrefix +
        (this.props.isNight ? 'icons/night.svg' : 'icons/day.svg')
    },
    1: {
    ...
    2: {
      ...
      imgSrc:
        this.iconPrefix +
        (this.props.isNight
          ? 'icons/cloudy-night-3.svg'
          : 'icons/cloudy-day-3.svg')
    },
    3: {
      description: 'Overcast',
      imgSrc:
        this.iconPrefix +
        (this.props.isNight ? 'icons/cloudy.svg' : 'icons/cloudy.svg')
    },
    45: {
      description: 'Fog',
    ...
    51: {
      ...
      imgSrc:
        this.iconPrefix +
        (this.props.isNight ? 'icons/rainy-4.svg' : 'icons/rainy-2.svg')
    },
    53: {
      description: 'Moderate drizzle',
      imgSrc:
        this.iconPrefix +
        (this.props.isNight ? 'icons/rainy-5.svg' : 'icons/rainy-3.svg')
    },
    55: {
    ...
    if (this.props.forecastWeather) {
      ...
      for (let i = 0; i < hourlyForecast.time.length; i++) {
        ...
        if (
          ...
          if (!daySet[new_day] && this.props.forecastWeather.daily) {
            ...
            hourlyForecast.temperature_2m[index] && (
              <div key={day + '_' + index} className='col flex-shrink-0'>
                <WeatherIcon
                  ...
                  isNight={
                    moment(hourlyForecast.time[index]).hour() > 18 ||
                    moment(hourlyForecast.time[index]).hour() < 6
                  }
                />
                ...
                <div className='small'>
                  <div style={{ fontWeight: 'normal' }}>
                    {hourlyForecast.wind_speed_10m[index]
                      ? hourlyForecast.wind_speed_10m[index].toFixed() +
                        wind_unit +
                        ' wind'
                      : ''}
                  </div>
    ...
    return (
      <div className='App'>
        ...
        <div className='text-muted small'>
          ...
          <a target='_blank' href='https://icons8.com/icon/5JFKFoWQfT74/fog'>
            {' '}
            Fog
          </a>{' '}
          icon by{' '}
